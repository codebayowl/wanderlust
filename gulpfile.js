...
function styles() {
    ...
    .pipe(dest('static/css/')) // outputting to static
    .pipe(browserSync.stream()) // adding watching w/o hard reload of page
}
...
function cleanImg() {
    return del('static/img/**/*', {force: true})
}
...
function scripts() {
    ...
    .pipe(dest('static/js/')) // outputting to static
    .pipe(browserSync.stream()) // adding watching w/o hard reload of page
}
...
exports.out         = series(cleanprod, buildjs, buildhtml, buildcss, buildimg);
